      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Aprenderás a tocar la batería desde tu casa', style: textStyleNormal, textAlign: TextAlign.center,),
            logo(context),
            customRaisedButton('Comenzar', Colors.white, Colors.black, context, WelcomePage()),
          ],
        ),
      ),
    );
